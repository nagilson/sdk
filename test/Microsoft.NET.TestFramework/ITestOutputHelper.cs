...
/// <c>ITestOutputHelper</c>. Previously that resolved to <c>Xunit.ITestOutputHelper</c>
/// (via a global <c>using Xunit</c>); now it resolves to this interface instead. The shape
/// is intentionally identical to xUnit v3's <c>ITestOutputHelper</c> so the shared sources
/// compile unchanged.
/// </summary>
