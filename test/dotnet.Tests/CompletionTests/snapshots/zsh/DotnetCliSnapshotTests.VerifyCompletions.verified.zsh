            ...
            case $line[1] in
                ...
                (clean)
                    _arguments "${_arguments_options[@]}" : \
                        ...
                        '--help[Show command line help.]' \
                        '-h[Show command line help.]' \
                        '*::PROJECT | SOLUTION | FILE -- The project or solution or C# (file-based program) file to operate on. If a file is not specified, the command will search the current directory for one.: ' \
                        && ret=0
                        case $state in
                            (dotnet_dynamic_complete)
                                local completions=()
